...
public class @GameControl : IInputActionCollection, IDisposable
{
    ...
    ""maps"": [
        {
            ""name"": ""Gameplay"",
            ""id"": ""dd00fc75-f108-4071-a25c-e389116107a0"",
            ""actions"": [
                {
                    ""name"": ""Moviment"",
                    ""type"": ""Value"",
                    ""id"": ""430ff05a-fcd1-44c7-bc57-042e4cd6e72c"",
                ...
                },
                {
                    ""name"": ""Jump"",
                    ""type"": ""Button"",
                    ""id"": ""735158e3-f558-4d09-b838-304a63686a10"",
            ...
            ""bindings"": [
                {
                    ""name"": ""Arrows"",
                    ""id"": ""7a9d285d-f9da-4fa4-9577-8d53c83a5183"",
                    ""path"": ""2DVector"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""up"",
                    ""id"": ""c126b0b8-bb02-446a-8cb1-429131275585"",
                ...
                {
                    ""name"": ""down"",
                    ""id"": ""7084077d-a6d4-4af7-b056-b09eeab48dd8"",
                ...
                {
                    ""name"": ""left"",
                    ""id"": ""9bbfb6a0-b296-482d-8cae-c7960228c22d"",
                ...
                {
                    ""name"": ""right"",
                    ""id"": ""76e61195-d579-4ffb-88dc-3a13b0abe247"",
                ...
                {
                    ""name"": ""WASD"",
                    ""id"": ""bc327518-c0c2-40ff-b308-b682e2a418a1"",
                    ""path"": ""2DVector"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""up"",
                    ""id"": ""54f50b19-0fb5-4618-9701-50126ee2d667"",
                    ""path"": ""<Keyboard>/w"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": ""Keyboard"",
                ...
                {
                    ""name"": ""down"",
                    ""id"": ""9d2d3fc7-9fea-4658-b635-90d74634f92c"",
                    ""path"": ""<Keyboard>/s"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": ""Keyboard"",
                ...
                {
                    ""name"": ""left"",
                    ""id"": ""d6d4f1c0-ac71-4b08-ba18-3991e77ca94c"",
                    ""path"": ""<Keyboard>/a"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""right"",
                    ""id"": ""4795fd6d-fdf7-4354-be37-736cb818c122"",
                    ""path"": ""<Keyboard>/d"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": ""Keyboard"",
                ...
                {
                    ""name"": """",
                    ""id"": ""9123b744-c7ef-47ca-a9c0-15101365dc6b"",
                    ""path"": ""<Keyboard>/space"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": ""Keyboard"",
        ...
        {
            ""name"": ""Menu"",
            ""id"": ""a0ebace5-3885-4d5b-a744-c4e0d54dc7fd"",
            ""actions"": [
                {
                    ""name"": ""New action"",
                    ""type"": ""Button"",
                    ""id"": ""73771c5e-6880-4689-b2cd-1a01391dfd9f"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """"
                }
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""1c590c8e-7d62-4b90-a559-fe8a984cc2c1"",
                    ""path"": """",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
